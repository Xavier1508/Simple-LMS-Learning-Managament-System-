<x-app-layout>
    ...
    <style>
        ...
        .fc .fc-button-primary { background-color: #F97316; border-color: #F97316; font-weight: 600; }
        .fc .fc-button-primary:hover, .fc .fc-button-primary:active { background-color: #EA580C; border-color: #EA580C; }
    ...
    <main class="flex-1 p-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-4">
                <div class="flex items-center"><span class="w-3 h-3 bg-blue-500 rounded-full mr-2"></span><span class="text-sm text-gray-600">Online Class</span></div>
                <div class="flex items-center"><span class="w-3 h-3 bg-orange-500 rounded-full mr-2"></span><span class="text-sm text-gray-600">Offline Class</span></div>
            </div>
        </div>
        <div id="calendar"></div>
    </main>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                if (typeof window.FullCalendar === 'undefined') {
                    console.error('FullCalendar global not loaded');
                    return;
                }
