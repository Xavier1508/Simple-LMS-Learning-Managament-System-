...
<body class="bg-gray-50 text-gray-800 font-sans">
    <div class="flex h-screen">
        ...
        <aside class="fixed top-0 left-0 h-screen w-60 bg-white border-r border-gray-200 flex flex-col p-5">
            <a href="/" class="text-2xl font-bold mb-8">Cinau</a>
            <nav class="flex flex-col gap-3">
                <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-md bg-orange-500 text-white font-medium">
                    <i class="fa-solid fa-chart-line"></i> Dashboard
                </a>
                <a href="{{ route('courses') }}" class="flex items-center gap-3 px-3 py-2 text-gray-600 hover:text-orange-500">
